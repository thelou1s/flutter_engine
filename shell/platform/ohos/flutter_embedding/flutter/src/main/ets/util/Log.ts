...
export default class Log {
   ...
   * @since 7
   */
  static d(tag: string, format: string, ...args: any[]) {
   ...
   * @since 7
   */
  static i(tag: string, format: string, ...args: any[]) {
   ...
   * @since 7
   */
  static w(tag: string, format: string, ...args: any[]) {
   ...
   * @since 7
   */
  static e(tag: string, format: string, ...args: any[]) {
   ...
   * @since 7
   */
  static f(tag: string, format: string, ...args: any[]) {
